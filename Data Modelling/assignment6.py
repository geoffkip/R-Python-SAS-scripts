...
#load up face mat dataset
mat = scipy.io.loadmat('/Users/geoffrey.kip/Desktop/Python class/DAT210x-master/Module4/Datasets/face_data.mat')
...
#
# .. your code here ..
label = pd.read_csv('/Users/geoffrey.kip/Desktop/Python class/DAT210x-master/Module5/Datasets/face_labels.csv')
label = label.iloc[:, 0]
print type(label)
#print label.head()
