...
import os
for file in os.listdir('/Users/geoffrey.kip/Desktop/Python class/DAT210x-master/Module5/Datasets/free-spoken-digit-dataset-master/recordings'):
    if file.startswith('0_jackson'):
        a = os.path.join('/Users/geoffrey.kip/Desktop/Python class/DAT210x-master/Module5/Datasets/free-spoken-digit-dataset-master/recordings', file)
...
rng   = check_random_state(7)  # Leave this alone 
...
#
# The test data will have two parts, X_test and y_test. X_test is
...
# X_train, and the remaining go into y_train. 
X_train = train[:, :int(Provided_Portion*n_audio_samples)]
y_train = train[:, int(Provided_Portion*n_audio_samples):]


#SciKit-Learn gets mad if you don't supply your training or testing
